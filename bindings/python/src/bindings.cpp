...
NB_MODULE(draconis, module) {
  ...
  nb::class_<DracCacheManager>(module, "SystemInfo")
    ...
    .def_static("get_uptime", []() -> uint64_t { return DracGetUptime(); }, "Get system uptime in seconds", nb::call_guard<nb::gil_scoped_release>())
    .def("get_mem_info", [](DracCacheManager* self) -> DracResourceUsage {
      ...
      return usage; }, "Get memory usage information", nb::call_guard<nb::gil_scoped_release>())
    .def("get_cpu_cores", [](DracCacheManager* self) -> DracCPUCores {
      DracCPUCores cores {};
      check_error(DracGetCpuCores(self, &cores), "get_cpu_cores");
      return cores; }, "Get CPU core counts", nb::call_guard<nb::gil_scoped_release>())
    .def("get_os", [](DracCacheManager* self) -> DracOSInfo {
      DracOSInfo info {};
      check_error(DracGetOperatingSystem(self, &info), "get_os");
      return info; }, "Get operating system information", nb::call_guard<nb::gil_scoped_release>())
    ...
    .def("get_disks", [](DracCacheManager* self) -> std::vector<DracDiskInfo> {
      ...
      return result; }, "Get information about all disks", nb::call_guard<nb::gil_scoped_release>())
    .def("get_system_disk", [](DracCacheManager* self) -> DracDiskInfo {
      DracDiskInfo info {};
      check_error(DracGetSystemDisk(self, &info), "get_system_disk");
      return info; }, "Get system disk information", nb::call_guard<nb::gil_scoped_release>())
    .def("get_outputs", [](DracCacheManager* self) -> std::vector<DracDisplayInfo> {
      ...
      return result; }, "Get information about all display outputs", nb::call_guard<nb::gil_scoped_release>())
    .def("get_primary_output", [](DracCacheManager* self) -> DracDisplayInfo {
      ...
      return info; }, "Get primary display information", nb::call_guard<nb::gil_scoped_release>())
    .def("get_network_interfaces", [](DracCacheManager* self) -> std::vector<DracNetworkInterface> {
      ...
      return result; }, "Get information about all network interfaces", nb::call_guard<nb::gil_scoped_release>())
    .def("get_primary_network_interface", [](DracCacheManager* self) -> DracNetworkInterface {
      ...
      return iface; }, "Get primary network interface information", nb::call_guard<nb::gil_scoped_release>())
    .def("get_battery_info", [](DracCacheManager* self) -> DracBattery {
      DracBattery bat {};
      check_error(DracGetBatteryInfo(self, &bat), "get_battery_info");
      return bat; }, "Get battery information", nb::call_guard<nb::gil_scoped_release>());
  ...
  nb::class_<DracPlugin>(module, "Plugin")
    ...
    .def("initialize", [](DracPlugin* self, DracCacheManager* cache) { check_error(DracPluginInitialize(self, cache), "plugin initialize"); }, nb::arg("cache"), "Initialize the plugin", nb::call_guard<nb::gil_scoped_release>())
    ...
    .def("collect_data", [](DracPlugin* self, DracCacheManager* cache) { check_error(DracPluginCollectData(self, cache), "plugin collect_data"); }, nb::arg("cache"), "Collect data from the plugin", nb::call_guard<nb::gil_scoped_release>())
    .def("get_json", [](DracPlugin* self) -> std::string {
      char* json = DracPluginGetJson(self);
      return take_string(json); }, "Get plugin data as JSON", nb::call_guard<nb::gil_scoped_release>())
    .def("get_fields", [](DracPlugin* self) -> std::vector<std::pair<std::string, std::string>> {
      ...
      return result; }, "Get plugin data as key-value pairs", nb::call_guard<nb::gil_scoped_release>())
